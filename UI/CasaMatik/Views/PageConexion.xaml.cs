...
namespace CasaMatik
{
    ...
    /// </summary>
    public sealed partial class PageConexion : Page
    {
        ...
        private void OnDeviceReady()
        {
            var action = Dispatcher.RunAsync(Windows.UI.Core.CoreDispatcherPriority.Normal, new Windows.UI.Core.DispatchedHandler(() =>
            {
                ...
                App.statConexion = "&#xE8CE;";
                this.Frame.Navigate(typeof(PageRiego));
            }));
        }
        ...
        private void ConnectionSelectComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            switch (ConnectionSelectComboBox.SelectedItem as string)
            {
                default:
                    break;
                case "Control Jardín":
                    ConnectionMethodComboBox.SelectedItem = "Network";
                    NetworkHostNameTextBox.Text = "192.168.2.63";
                    NetworkPortTextBox.Text = "6063";
                    break;
            }
        }
    }
